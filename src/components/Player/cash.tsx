	...
	render() {
		...
		return recipient ? (
			<div className="player-cash">
				<PrimaryTitle className="player-cash_title">Nakit Transferi</PrimaryTitle>
				...
				<div className="player-cash_footer">
					<OutlineButton onClick={this.closeMenu.bind(this)}>İptal</OutlineButton>
					<GradientButton form="cash">Gönder</GradientButton>
				</div>
			</div>
		) : null;
	}
