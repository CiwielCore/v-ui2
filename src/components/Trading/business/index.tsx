			...
			<div className="trading trading--business">
				<div className="trading_top">
					<PrimaryTitle className="trading_title">
						{`${seller ? 'İşletme Satın Alımı' : 'İşletme Satışı'}`}
					</PrimaryTitle>
					...
					<div className="trading_info">
						<div className="trading_info-items">
							<p className="trading_info-item">
								Devlet Fiyatı: <b>{prettify.price(govPrice)}</b>
							</p>
							<p className="trading_info-item">
								Gelir: <b>{prettify.price(income)}</b>
							</p>
						</div>
					</div>
				</div>
				...
				<div className="trading_footer">
					<OutlineButton onClick={this.refuse}>Kapat</OutlineButton>

					{seller ? (
						<GradientButton onClick={this.buy}>Satın Al</GradientButton>
					) : (
						<GradientButton onClick={this.sell.bind(this)}>Teklif Et</GradientButton>
					)}
				</div>
			</div>
		);
