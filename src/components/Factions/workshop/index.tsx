...
export default class Workshop extends Component<Props, State> {
	...
	async getProduct() {
		...
		try {
			...
			showNotification('success', 'Ürün başarıyla üretildi');
		} catch (err) {
			...
			<div className="workshop">
				<div className="workshop_container">
					<div className="workshop_header">
						<PrimaryTitle className="workshop_title">Atölye</PrimaryTitle>
				...
				<div className="workshop_footer">
					...
					<GradientButton onClick={this.getProduct.bind(this)}>Üret</GradientButton>
				</div>
			</div>
		);
	}
