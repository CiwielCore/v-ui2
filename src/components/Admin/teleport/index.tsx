			...
			>
				{(formik) => (
					<Form>
						...
						>
							<TabPane tab="Oyuncuya" key="player">
								<Players onChange={(data) => formik.setFieldValue('player', data.id)} />
								<GradientButton type="submit">Onayla</GradientButton>
							</TabPane>

							<TabPane tab="Kendine" key="yourself">
								<Players onChange={(data) => formik.setFieldValue('player', data.id)} />
								<GradientButton type="submit">Onayla</GradientButton>
							</TabPane>

							<TabPane tab="İşaretli Noktaya" key="waypoint">
								<GradientButton type="submit">Onayla</GradientButton>
							</TabPane>

							<TabPane tab="Koordinatlar" key="coords">
