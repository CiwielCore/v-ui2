...
class VehicleShop extends Component<Props, State> {
	...
	async buy() {
		...
		try {
			...
			showNotification(
				'success',
				'Aracı başarıyla satın aldınız, telefon uygulamasından teslim edebilirsiniz'
			);
		} catch (err) {
			...
			<div className="vehicle-shop">
				...
				<div className="vehicle-shop_main">
					...
					<div className="vehicle-shop_buttons">
						...
						<GradientButton onClick={this.buy.bind(this)}>Satın Al</GradientButton>
					</div>
				</div>
			</div>
		);
