			...
			<div className="sim">
				...
				{form ? (
					...
					<form className="sim_form">
						<input type="text" value={phoneNumber || 'Yok'} readOnly />

						<Button onClick={this.openForm.bind(this, 'random')}>Rastgele</Button>
						<Button onClick={this.openForm.bind(this, 'custom')}>İstediğim</Button>
					</form>
				)}
